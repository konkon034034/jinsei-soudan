...
【重要：話題の切り替え】
ニューストピックが変わるときは、必ず切り替えのセリフを入れてください。
コードで強制挿入ではなく、台本の自然な流れとして生成してください。

＜必須＞
各ニュースセクションの冒頭に、以下のような導入を入れる:
- カツミ「では、次のニュースです」
- カツミ「続いての話題はこちら」
- カツミ「さて、次のお話です」
- ヒロシ「次は？」→ カツミ「次はですね...」
...
＜悪い例＞
いきなり次のニュース内容を話し始める:
カツミ「厚生労働省が発表しました」← 唐突すぎる

＜良い例＞
カツミ「...というわけで、備えが大切ですね」
ヒロシ「なるほど〜」
カツミ「では、次のニュースにいきましょう。厚生労働省が...」← 自然な流れ

毎回必ず話題の切り替えを明示してください。
